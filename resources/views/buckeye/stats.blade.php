            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-gray-700 p-3 md:px-4 md:pt-4 md:pb-5 text-gray-100 font-body rounded md:rounded-md shadow-lg">
                        ...
                        <div class="p-4 bg-gray-800 rounded-md">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-gray-700 rounded-lg p-4 text-center {{ isset($userStats->guess_distribution[1]) && $userStats->guess_distribution[1] > 0 ? 'opacity-100' : 'opacity-40' }}">
                                ...
                                <div class="bg-gray-700 rounded-lg p-4 text-center {{ $userStats->games_won >= 100 ? 'opacity-100' : 'opacity-40' }}">
                                    <div class="w-12 h-12 bg-gray-600 rounded-full mx-auto mb-3 flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
