                        ...
                        <div
                            ...
                            x-init="
                                if (!initialized && typeof $ !== 'undefined') {
                                    initialized = true;
                                    let $el = $('#list-item-desc-{{ $block['id'] }}-{{ $item['id'] }}');
                                    $el.trumbowyg({
                                        btns: [
                                            ['strong', 'em', 'del'],
                                    ...
                                    $el.on('tbwchange', function() {
                                        $wire.set('blocks.{{ $index }}.data.items.{{ $itemIndex }}.description', $el.trumbowyg('html'));
                                    });
                                }
                            ">
                            ...
                            <div class="trumbowyg-dark" wire:ignore>
                                <textarea id="list-item-desc-{{ $block['id'] }}-{{ $item['id'] }}">{{ $item['description'] ?? '' }}</textarea>
                            </div>
