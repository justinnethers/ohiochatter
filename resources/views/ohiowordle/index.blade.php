        ...
        @auth
            <article class="bg-gray-800 text-white p-6 rounded-xl space-y-4">
                <div class="flex justify-between">
                    ...
                    <a href="{{ route('ohiowordle.stats') }}" class="hover:underline">
                        See More
                    </a>
                </div>
        ...
        @else
            <article>
                <x-well color="gray" shade="800">
                    ...
                    <x-well>
                        <h3 class="text-lg font-bold mb-2 text-amber-400">Enjoying OhioWordle?</h3>
                        <p class="mb-3">
                                ...
                                <x-well>
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400">See your win rate, streaks, and guess distribution</p>
                                        </div>
                                    </div>
                                </x-well>
                                <x-well>
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400">View all your past puzzles and solutions</p>
                                        </div>
                                    </div>
                                </x-well>
                                <x-well>
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400">Earn special badges for your accomplishments</p>
                                        </div>
                                    </div>
                                </x-well>
                            </div>
        ...
        <article>
            <x-well color="gray" shade="800">
                ...
                <div class="prose prose-invert max-w-none">
                    <h3 class="text-sm mb-6 text-600">
                        Guess the Ohio-themed word in 6 tries! Each guess must be a valid word.
                    </h3>

                    <x-well>
                        <h4 class="text-gray-200 mt-0">Color Hints</h4>
                        <div class="space-y-2">
                            <div class="flex items-center gap-2">
                                <div class="w-8 h-8 bg-red-600 rounded flex items-center justify-center font-bold text-white">O</div>
                                <span class="text-sm">Letter is in the correct spot (Scarlet)</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <div class="w-8 h-8 bg-gray-400 rounded flex items-center justify-center font-bold text-white">H</div>
                                <span class="text-sm">Letter is in the word but wrong spot (Gray)</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <div class="w-8 h-8 bg-gray-700 rounded flex items-center justify-center font-bold text-white">X</div>
                                <span class="text-sm">Letter is not in the word</span>
                            </div>
                        </div>
                    </x-well>

                    <p class="mt-4">A new puzzle is available each day. Come back tomorrow for another challenge!</p>
                </div>
            </x-well>
        </article>
