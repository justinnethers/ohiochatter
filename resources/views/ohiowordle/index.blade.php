<x-app-layout :seo="$seo ?? null">
    ...
    <x-slot name="head">
        ...
        <meta property="og:description"
              content="Guess the Ohio-themed word in 6 tries! Test your knowledge of the Buckeye State with our daily word puzzle.">
    ...
    <div class="container mx-auto space-y-6 px-2 md:px-0">
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <aside class="bg-steel-800/50 rounded-xl border border-steel-700/30 p-5 lg:w-80 lg:flex-shrink-0">
                ...
                <div
                    class="bg-gradient-to-r from-green-900/30 to-transparent border-l-4 border-green-500 pl-3 py-2 mb-4 rounded-r">
                    <p class="text-white font-medium mb-1">Guess the Ohio word in 6 tries!</p>
                    <p class="text-gray-400 text-sm">Each answer is Ohio-related: cities, towns, athletes, politicians,
                        landmarks, and more.</p>
                    <p class="text-gray-400 text-sm mt-2"><strong class="text-gray-300">Note:</strong> Your guesses can
                        be any valid dictionary word—use common words to find letters! But the answer will always be
                        Ohio-related.</p>
                </div>
                ...
                <div class="space-y-2 mb-5">
                    <div class="flex items-center gap-3 bg-gray-800/50 rounded-lg p-2">
                        <div
                            class="w-8 h-8 bg-green-600 rounded flex items-center justify-center font-bold text-white text-sm shadow-lg shadow-green-600/30">
                            O
                        </div>
                    ...
                    <div class="flex items-center gap-3 bg-gray-800/50 rounded-lg p-2">
                        <div
                            class="w-8 h-8 bg-yellow-500 rounded flex items-center justify-center font-bold text-white text-sm shadow-lg shadow-yellow-500/30">
                            H
                        </div>
                    ...
                    <div class="flex items-center gap-3 bg-gray-800/50 rounded-lg p-2">
                        <div
                            class="w-8 h-8 bg-gray-700 rounded flex items-center justify-center font-bold text-white text-sm">
                            X
                        </div>
